...
SSL_set_tlsext_offer_micro_fragments,
...
=head1 SYNOPSIS
 ...
 int SSL_set_tlsext_offer_micro_fragments(SSL_CTX *ctx, uint8_t mode);
...
SSL_set_tlsext_offer_micro_fragments() if set to 1,
micro-fragmentation is offerd in the client hallo.
